...
## In Progress
- Residual dense-scene tuning for strongest-object stability and non-focal track quality

## Next
- Continue improving strongest-object stability in crowded scenes without introducing site-specific logic
- Consider replacing single-threshold object identification with multithreshold / hierarchical segmentation to further reduce split/merge churn
- Phase 3: Velocity ingestion, velocity region detection
- NVGT frontend integration with the REST API

## Blockers / Decisions
- No blocker for current API behavior. Remaining work is quality-related: dense scenes still need stronger focal-object stability and better non-focal track behavior.
