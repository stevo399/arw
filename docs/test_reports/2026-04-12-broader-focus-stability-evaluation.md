...
- `2026-04-10T23:30:07Z objects=57 active=69 uncertain=18 max_speed_mph=87 merges=11 splits=7 focus_track=1 focus_identity=high:0.84 focus_continuity=medium:0.7 focus_heading=SE focus_motion_conf=high:0.9`
...
- `2026-04-10T23:40:53Z objects=48 active=54 uncertain=9 max_speed_mph=33 merges=7 splits=2 focus_track=1 focus_identity=high:0.88 focus_continuity=medium:0.7 focus_heading=SE focus_motion_conf=high:0.98`
- `2026-04-10T23:46:05Z objects=48 active=56 uncertain=13 max_speed_mph=20 merges=5 splits=5 focus_track=1 focus_identity=high:0.79 focus_continuity=medium:0.7 focus_heading=WNW focus_motion_conf=high:0.98`
- `2026-04-10T23:51:18Z objects=50 active=56 uncertain=9 max_speed_mph=20 merges=8 splits=3 focus_track=1 focus_identity=high:0.81 focus_continuity=medium:0.7 focus_heading=uncertain focus_motion_conf=low:0.0`
- `2026-04-10T23:56:21Z objects=50 active=61 uncertain=10 max_speed_mph=21 merges=6 splits=6 focus_track=1 focus_identity=high:0.81 focus_continuity=medium:0.7 focus_heading=uncertain focus_motion_conf=low:0.0`
...
- `2026-04-10T23:35:42Z objects=3 active=3 uncertain=0 max_speed_mph=0 merges=1 splits=0 focus_track=1 focus_identity=medium:0.73 focus_continuity=medium:0.55 focus_heading=nearly stationary focus_motion_conf=medium:1.0`
- `2026-04-10T23:44:23Z objects=2 active=2 uncertain=0 max_speed_mph=0 merges=1 splits=0 focus_track=1 focus_identity=medium:0.74 focus_continuity=medium:0.55 focus_heading=nearly stationary focus_motion_conf=medium:1.0`
- `2026-04-10T23:53:02Z objects=7 active=7 uncertain=0 max_speed_mph=0 merges=1 splits=1 focus_track=1 focus_identity=medium:0.71 focus_continuity=medium:0.55 focus_heading=nearly stationary focus_motion_conf=medium:0.99`
...
- `2026-04-10T23:47:20Z objects=18 active=19 uncertain=4 max_speed_mph=9 merges=5 splits=1 focus_track=11 focus_identity=high:0.79 focus_continuity=low:0.35 focus_heading=nearly stationary focus_motion_conf=medium:0.99`
- `2026-04-10T23:52:02Z objects=18 active=22 uncertain=3 max_speed_mph=13 merges=1 splits=2 focus_track=11 focus_identity=medium:0.59 focus_continuity=medium:0.55 focus_heading=nearly stationary focus_motion_conf=medium:0.99`
- `2026-04-10T23:56:44Z objects=20 active=19 uncertain=1 max_speed_mph=35 merges=3 splits=1 focus_track=25 focus_identity=high:0.83 focus_continuity=low:0.3 focus_heading=NNE focus_motion_conf=high:0.99`
